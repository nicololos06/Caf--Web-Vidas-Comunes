...
/* ===================================
    ...
    // Abre o cierra el menú al hacer click en el botón del menú
$(".foholic-menubar").on("click", function (e) {
  e.stopPropagation();
...
$(document).on("click", function (e) {
  if (!$(e.target).closest(".foholic-fixed-sidebar, .foholic-menubar").length) {
    $(".foholic-fixed-sidebar").removeClass("open-menu");
    $(".foholic-menubar").removeClass("menu-open");
  }
});

$(".foholic-fixed-sidebar a").on("click", function () {
  $(".foholic-fixed-sidebar").removeClass("open-menu");
  $(".foholic-menubar").removeClass("menu-open");
});
...
// Solo activar menú si NO es móvil
if (!isMobile()) {
  $(".foholic-menubar").on("click", function (e) {
    e.stopPropagation();
    $(".foholic-fixed-sidebar").toggleClass("open-menu");
